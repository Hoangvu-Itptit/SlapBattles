...
public class Targetvariant : MonoBehaviour
{
    ...
    /// </summary>
    [HideInInspector] public IndicatorVariant indicator;
    ...
    {
        if (OffScreenIndicatorVarriant.TargetStateChanged != null)
        {
            OffScreenIndicatorVarriant.TargetStateChanged.Invoke(this, true);
        }
    }
    ...
    private void OnDisable()
    {
        if (OffScreenIndicatorVarriant.TargetStateChanged != null)
        {
            OffScreenIndicatorVarriant.TargetStateChanged.Invoke(this, false);
        }
    }
